...
class Application {
    ...
    constructor(canvas) {
        ...
        // Disable resize for IPhone, manually add height for nwvbar hide
        if (isIphone) {
...
class Circle {
     ...
     */
    render(context) {
        //context.fillStyle = "hsl(" + Math.random(100) + ", 100%, " + this.size * 4+"%)";
        context.fillStyle = "hsl(202, 10%, "+this.size * 2.5+"%)";
